...
class MiniDataset(Dataset):
    ...
    def __init__(self, mode='train', root='..' + os.sep + 'dataset4', transform=None, target_transform=None, return_path=False):
        IMAGE_PATH = os.path.join(root, 'data')
        SPLIT_PATH = os.path.join(root, 'splits/vinyals/')
        txt_path = osp.join(SPLIT_PATH, mode + '.csv')
        ...
        if mode == 'val' or mode == 'test':
            ...
            self.transform = transforms.Compose([
                ...
                transforms.ToTensor(),
                # transforms.Normalize([x / 255.0 for x in [120.39586422, 115.59361427, 104.54012653]],
